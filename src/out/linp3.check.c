...
((x86==x80) && (x87==x81))) &&
((x86==x83) && (x87==x84))) &&
((\forall int  x141; (\forall int  x142; ((((0<=x141) && (x141<(x86*x87))) && ((0<=x142) && (x142<(x80*x81)))) ==> \separated(x85+x141,x79+x142)))) &&
(\forall int  x161; (\forall int  x162; ((((0<=x161) && (x161<(x86*x87))) && ((0<=x162) && (x162<(x83*x84)))) ==> \separated(x85+x161,x82+x162))))));
ensures (((inv_matrix_Boolean(x79,x80,x81) && inv_matrix_Boolean(x82,x83,x84)) && inv_matrix_Boolean(x85,x86,x87)) &&
(\forall int  x188; (((0<=x188) && (x188<(x86*x87))) ==> (x85[x188]==(x79[x188] || x82[x188])))));
*/
...
/*@
requires (((inv_matrix_Boolean(x204,x205,x206) && inv_matrix_Boolean(x207,x208,x209)) &&
((x208==x205) && (x209==x206))) &&
(\forall int  x248; (\forall int  x249; ((((0<=x248) && (x248<(x208*x209))) && ((0<=x249) && (x249<(x205*x206)))) ==> \separated(x207+x248,x204+x249)))));
ensures (((inv_matrix_Boolean(x204,x205,x206) && inv_matrix_Boolean(x207,x208,x209)) &&
(\forall int  x274; (((0<=x274) && (x274<(x208*x209))) ==> (x207[x274]==(x203 && x204[x274]))))) &&
