...
ensures (((\forall int  x532; (((0<=x532) && (x532<(x221-1))) ==> ((x219[x532]<x219[(x532+1)]) || ((x219[x532]==x219[(x532+1)]) && (x219[(x532+1)]<=x220[(x532+1)]))))) && __Int_Int___Permut{Old,Post}(x219,x220,x221)) && (\forall int  x554; (\forall int  x555; (((((0<=x554) && (x554<x221)) && (0<=x555)) && (x555<x221)) ==> \separated(x219+x554,x220+x555)))));
assigns x219[(0..x221-1)], x220[(0..x221-1)];
*/
void insort_pairs(int  * x219, int  * x220, int  x221) {
  int x224 = x221;
  /*@
  loop invariant ((((((0<=x224) && (x224<=x221)) && ((x224<(x221-1)) ==> (\forall int  x421; (((x224<=x421) && (x421<(x221-1))) ==> ((x219[x421]<x219[(x421+1)]) || ((x219[x421]==x219[(x421+1)]) && (x219[(x421+1)]<=x220[(x421+1)]))))))) && (\forall int  x445; ((((0<=x445) && (x445<x224)) && (x224<=(x221-1))) ==> ((x219[x445]<x219[x224]) || ((x219[x445]==x219[x224]) && (x219[x224]<=x220[x224])))))) && __Int_Int___Permut{Pre,Here}(x219,x220,x221)) && (\forall int  x475; (\forall int  x476; (((((0<=x475) && (x475<x221)) && (0<=x476)) && (x476<x221)) ==> \separated(x219+x475,x220+x476)))));
    ...
    */
    for(int x231=0; x231 < x229; x231++) {
      ...
      if (x241) {
        ...
        //@assert ((x219[x231]<x219[x228]) || ((x219[x231]==x219[x228]) && (x219[x228]<=x220[x228])));
      }
    }
    int x341 = x228;
    int x340 = x229 - 1;
    inswap___Int_Int__(x219,x220,x340,x341,x221);
    //@assert (\forall int  x343; ((((x224-1)<x343) && (x343<(x221-1))) ==> ((x219[x343]<x219[(x343+1)]) || ((x219[x343]==x219[(x343+1)]) && (x219[(x343+1)]<=x220[(x343+1)])))));
    //@assert ((x224<=(x221-1)) ==> ((x219[(x224-1)]<x219[x224]) || ((x219[(x224-1)]==x219[x224]) && (x219[x224]<=x220[x224]))));
    //@assert (\forall int  x386; (((0<=x386) && (x386<x224)) ==> ((x219[x386]<x219[(x224-1)]) || ((x219[x386]==x219[(x224-1)]) && (x219[(x224-1)]<=x220[(x224-1)])))));
    x224 = x340;
  }
}
