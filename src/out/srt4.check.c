...
/*@
requires (((x179>0) && (\valid(x177+(0..x179-1)) && \valid(x178+(0..x179-1)))) && (\forall int  x430; (\forall int  x431; (((((0<=x430) && (x430<x179)) && (0<=x431)) && (x431<x179)) ==> \separated(x177+x430,x178+x431)))));
ensures ((\forall int  x450; (((0<=x450) && (x450<(x179-1))) ==> ((x177[x450]<x177[(x450+1)]) || ((x177[x450]==x177[(x450+1)]) && (x177[(x450+1)]<=x178[(x450+1)]))))) && __Int_Int___Permut{Old,Post}(x177,x178,x179));
assigns x177[(0..x179-1)], x178[(0..x179-1)];
*/
void insort_pairs(int  * x177, int  * x178, int  x179) {
  int x182 = x179;
  /*@
  loop invariant (((((0<=x182) && (x182<=x179)) && ((x182<(x179-1)) ==> (\forall int  x359; (((x182<=x359) && (x359<(x179-1))) ==> ((x177[x359]<x177[(x359+1)]) || ((x177[x359]==x177[(x359+1)]) && (x177[(x359+1)]<=x178[(x359+1)]))))))) && (\forall int  x383; ((((0<=x383) && (x383<x182)) && (x182<=(x179-1))) ==> ((x177[x383]<x177[x182]) || ((x177[x383]==x177[x182]) && (x177[x182]<=x178[x182])))))) && __Int_Int___Permut{Pre,Here}(x177,x178,x179));
  ...
  */
  for (;;) {
    ...
    int x187 = x182;
    /*@
    loop invariant (((((((((0<=x182) && (x182<=x179)) && (0<=x189)) && (x189<=x182)) && (0<=x186)) && (x186<=(x182-1))) && ((x182-1)<x179)) && (\forall int  x247; (((0<=x247) && (x247<x189)) ==> ((x177[x247]<x177[x186]) || ((x177[x247]==x177[x186]) && (x177[x186]<=x178[x186])))))) && __Int_Int___Permut{Pre,Here}(x177,x178,x179));
    ...
    */
    ...
    int x279 = x186;
    int x278 = x187 - 1;
    inswap___Int_Int__(x177,x178,x278,x279,x179);
    //@assert (\forall int  x281; ((((x182-1)<x281) && (x281<(x179-1))) ==> ((x177[x281]<x177[(x281+1)]) || ((x177[x281]==x177[(x281+1)]) && (x177[(x281+1)]<=x178[(x281+1)])))));
    //@assert ((x182<=(x179-1)) ==> ((x177[(x182-1)]<x177[x182]) || ((x177[(x182-1)]==x177[x182]) && (x177[x182]<=x178[x182]))));
    //@assert (\forall int  x324; (((0<=x324) && (x324<x182)) ==> ((x177[x324]<x177[(x182-1)]) || ((x177[x324]==x177[(x182-1)]) && (x177[(x182-1)]<=x178[(x182-1)])))));
    x182 = x278;
  }
}
