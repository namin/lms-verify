  ...
  */
  for(int x466=0; x466 < x464; x466++) {
    ...
    */
    ...
    /*@assert ((x214[x541]<x214[x542]) || ((x214[x541]==x214[x542]) &&
    (x215[x541]<=x215[x542])));*/
    int x607 = x541;
    ...
    /*@assert ((x214[x466]<x214[x542]) || ((x214[x466]==x214[x542]) &&
    (x215[x466]<=x215[x542])));*/
    /*@assert (\forall int  x656; (((0<=x656) &&
    (x656<x542)) ==> ((x214[x656]<x214[(x656+1)]) || ((x214[x656]==x214[(x656+1)]) &&
    (x215[x656]<=x215[(x656+1)])))));*/
    /*@assert (\forall int  x674; (((x542<=x674) &&
