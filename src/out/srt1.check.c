...
ensures (\forall int  x302; (((0<=x302) && (x302<(x121-1))) ==> (x120[x302]<=x120[(x302+1)])));
assigns x120[(0..x121-1)];
*/
void insort(int  * x120, int  x121) {
  int x124 = x121;
  /*@
  loop invariant ((((0<=x124) && (x124<=x121)) && ((x124<(x121-1)) ==> (\forall int  x250; (((x124<=x250) && (x250<(x121-1))) ==> (x120[x250]<=x120[(x250+1)]))))) && (\forall int  x267; ((((0<=x267) && (x267<x124)) && (x124<=(x121-1))) ==> (x120[x267]<=x120[x124]))));
  ...
  */
  for (;;) {
    ...
    int x129 = x124;
    /*@
    loop invariant ((((((((0<=x124) && (x124<=x121)) && (0<=x131)) && (x131<=x124)) && (0<=x128)) && (x128<=(x124-1))) && ((x124-1)<x121)) && (\forall int  x169; (((0<=x169) && (x169<x131)) ==> (x120[x169]<=x120[x128]))));
    ...
    */
    ...
    int x191 = x128;
    int x190 = x129 - 1;
    inswap(x120,x190,x191,x121);
    //@assert (\forall int  x193; ((((x124-1)<x193) && (x193<(x121-1))) ==> (x120[x193]<=x120[(x193+1)])));
    //@assert ((x124<=(x121-1)) ==> (x120[(x124-1)]<=x120[x124]));
    //@assert (\forall int  x222; (((0<=x222) && (x222<x124)) ==> (x120[x222]<=x120[(x124-1)])));
    x124 = x190;
  }
}
